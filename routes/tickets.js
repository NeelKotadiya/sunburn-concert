...
router.post('/submit', async (req, res) => {
    const { name, email, ticketType,transactionId,mobile,isScanned ,totalAmount} = req.body.data;
   
    try {
        const newTicket = new Ticket({ name, email, ticketType,transactionId,mobile,isScanned,totalAmount});
